...
export default class extends abstractviews {
  ...
  async getHtml() {
    ...
    const cssFiles = [
      "https://" +
        DNS +
        ":8083/sudokubattle/static/css/lobby.css?request_by=Home",
      "https://" +
        DNS +
        ":8083/sudokubattle/static/css/navbar.css?request_by=Home",
      "https://" +
        DNS +
        ":8083/sudokubattle/static/css/sudoku.css?request_by=Home",
      "https://" +
        DNS +
        ":8083/sudokubattle/static/css/waiting.css?request_by=Home",
    ];
    ...
    const response = await fetch(
      "https://" + DNS + ":8083/sudokubattle/" + room_name + "?request_by=Home"
    );
